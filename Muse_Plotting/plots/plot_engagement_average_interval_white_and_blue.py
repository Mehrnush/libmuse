...
def generate_plot_engagement_average_interval_blue_and_white(participant, interval=1):
...
if __name__ == "__main__":
    for p in participants:
        interval = 10
        plot = generate_plot_engagement_average_interval_blue_and_white(participant=p, interval=interval)
